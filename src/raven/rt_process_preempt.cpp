 ...
 *  This function creates a pool of memory in ram for use with any malloc or new
 * calls so that they do not cause page faults.
...
static void *rt_process(void *) {
  param_pass currParams = {0};  // robot command struct
